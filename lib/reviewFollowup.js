...
// Given 'Tuesday' or 'Friday', returns the next occurrence of that weekday
// (as a UK-calendar YYYY-MM-DD string) after today. Orders are always placed
// ahead of their delivery day, so this never resolves to today.
export function nextDeliveryDate(deliveryDay) {
  const targetDow = deliveryDay === 'Friday' ? 5 : 2; // Tue=2, Fri=5
